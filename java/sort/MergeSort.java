...
public class MergeSort {
   /*
     ...
     * 
     * Key Points
     * -> Merge Sort unlike Quick Sort is not in place sorting algorithm.
     * -> Merge Sort is stable.
     * -> Merge Sort is better when data is huge and stored on external storage.
     * -> Merge Sort requires O(N) extra storage, N being the array size. 
     * */
