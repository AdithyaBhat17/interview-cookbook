...
PROBLEM:
You are given a integer n find how many ways you can make palindrome number consisting of n digits and 
print it also you are not supposed to use any array or character array means you can only use recursion.
